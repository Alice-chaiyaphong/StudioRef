...
const SAMPLE_PROMPTS = [
  "แนะนำสีและ Typography สำหรับเว็บคลินิกผิวหนังออร์แกนิกสไตล์ญี่ปุ่น",
  "ขอแนวคิดมู้ดบอร์ดแอปพลิเคชันขายเซรามิกแฮนด์เมดสีครีมอบอุ่น",
  "ช่วยออกแบบพาเลทสีและเลย์เอาต์เมนูร้านกาแฟสเปเชียลตี้โกโก้ในป่า",
  "วิธีจัดวาง Negative space สำหรับ Portfolio สถาปนิกมินิมอล"
];
  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      id: 'welcome',
      sender: 'ai',
      text: 'สวัสดีค่ะ! ดิฉัน StudioRef AI Senior Consultant พร้อมช่วยวิเคราะห์โจทย์ดีไซน์ แนะนำโทนสีออร์แกนิก การจับคู่ฟอนต์ และเลย์เอาต์สไตล์ธรรมชาติให้คุณ ลองพิมพ์เล่าโปรเจกต์งานที่คุณกำลังทำอยู่ได้เลยค่ะ 🌿',
